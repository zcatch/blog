                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="get" action="{{url('admin/permission')}}">
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="permission_name"  value="{{$request->input('permission_name')}}" placeholder="请输入权限名称" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                              ...
                              @foreach($permission as $item)
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    ...
                                    <a title="编辑"  onclick="xadmin.open('编辑','{{url('admin/permission/'.$item->id.'/edit')}}',600,400)" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
