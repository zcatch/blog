    ...
    <div id="main-wrap-left">
     ...
     <section class="catlist-8 catlist clr">
      <div class="catlist-container clr">
       <h2 class="home-heading clr"> <span class="heading-text"> {{ $v->cate_name }} </span> <a href="/lists/{{$v->cate_id}}">+ 更多</a> </h2>
       @if(!empty($v->article))
       ...
       <span class="col-left catlist-style2">
          ...
          <article class="home-blog-entry clr">
           ...
           <div class="postlist-meta">
            ...
            <div class="postlist-meta-collect collect @if(in_array($n->art_id,$userCollect)) collect-yes @else collect-no @endif " uid="@if (!is_null($user)){{$user->user_id}}@endif" artid="{{ $n->art_id }}" style="float:right;cursor:pointer;" title="必须登录才能收藏">
