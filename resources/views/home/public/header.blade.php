    ...
    <!-- Focus us -->
        <div id="focus-us">
            ...
            <div id="focus-slide" class="ie_pie">
                ...
                <p class="focus-content"><a href="#" target="_blank" class="sinaweibo"><span><i class="fa fa-weibo"></i>新浪微博</span></a>
                    <a href="http://t.qq.com/iydu_net" target="_blank" class="sinaweibo"><span><i class="fa fa-tencent-weibo"></i>腾讯微博</span></a>
                </p>
                <div class="focus-title">
                    联系我们
                </div>
                <p class="focus-content" style="line-height: 20px;margin-bottom: 10px;">
                    <a href="#" target="_blank" class="qq"><span><i class="fa fa-qq"></i>QQ</span></a>
                    <a href="#" target="_blank"><span><i class="fa fa-envelope"></i>发送邮件</span></a>
                ...
                <p class="focus-content">订阅到： <a rel="external nofollow" target="_blank" href="#">鲜果</a>
                    <a rel="external nofollow" target="_blank" href="#">有道</a>
                    <a rel="external nofollow" target="_blank" href="#">Feedly</a></p>
            ...
            <div class="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95-container">
                <ul id="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95" class="nav-menu">
                    ...
                    @foreach($cateone as $k=>$v)
                        <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-4316">
                            <a href="{{ url('/lists/'.$v->cate_id) }}">{{ $v->cate_name }}</a>
                            @if(!empty($catetwo[$k]))
                                <ul class="sub-menu">
                                    @foreach($catetwo[$k] as $m=>$n)
                                        <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-4317">
                                            <a href="{{ url('/lists/'.$n->cate_id) }}">{{ $n->cate_name }}</a></li>
                                    @endforeach
